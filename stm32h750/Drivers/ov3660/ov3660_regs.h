/*
 * Derived from esp32-camera (https://github.com/espressif/esp32-camera),
 * sensors/private_include/ov3660_regs.h, licensed under the Apache License 2.0.
 * Modifications for the Kestrel STM32 port: removed ESP-IDF specifics
 * (esp_attr.h, DRAM_ATTR) and inlined the ratio_settings_t definition.
 * This file remains under the Apache License 2.0; see
